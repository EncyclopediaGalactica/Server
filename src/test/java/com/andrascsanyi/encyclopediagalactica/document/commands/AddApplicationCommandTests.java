...
public class AddApplicationCommandTests extends EncyclopediaGalacticaApplicationBaseTest {
    ...
    @Test
    public void createApplication() throws GetAllApplicationsCommandException, AddApplicationCommandException {
        ApplicationInput input = ApplicationInput.builder().id("0").name("name").description("desc").build();
        ApplicationOutput r = addApplicationCommand.addApplication(input);
